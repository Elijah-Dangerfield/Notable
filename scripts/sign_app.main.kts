...
if (isHelpCall) {
    printGreen(
        """
        This script signs the app based on the apk or aab with a given path. This is mainly used by my CI. 
...
fun main() {
    ...
    check(!assetPath.contains("debugsigned")) {
        """
            ...
            Please make sure that the gradle.property com.notable.releaseDebugSigningEnabled is set to false BEFORE
